  ...
  return (
    <>
      <div className="relative min-h-screen w-full overflow-hidden">
        ...
        <img
          src="/bg.svg"
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[1568px] min-h-full object-cover pointer-events-none select-none z-0"
          alt="bg"
        />
        <img
          src="/left.svg"
          className="absolute top-0 left-0 w-[223px] min-h-full object-cover pointer-events-none select-none z-0"
          alt="left"
        />
        <img
          src="/right.svg"
          className="absolute top-0 right-0 w-[223px] min-h-full object-cover pointer-events-none select-none z-0"
          alt="right"
        />
        <img
          src="/tree.svg"
